{{--
    Port of tailadmin/resources/views/components/ui/alert.blade.php, trimmed
    to the props this app actually uses (variant, title, slot) but keeping
    the original's per-variant icon — dropped in an earlier pass, restored
    here since it's what makes the four variants visually distinct at a
    glance, not just by border color.
--}}
@props([
    'variant' => 'info',
    'title' => '',
