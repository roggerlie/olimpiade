{{-- Ported from tailadmin/resources/views/components/ui/button.blade.php --}}
@props([
    'size' => 'md',
    'variant' => 'primary',
    'startIcon' => null,
...
@php
    ...
    $classes = trim("{$base} {$sizeMap[$size]} {$variantMap[$variant]}").($disabled ? ' cursor-not-allowed opacity-50' : '');
@endphp
