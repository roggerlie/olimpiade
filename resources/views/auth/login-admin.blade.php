    ...
    <div class="flex min-h-screen w-full items-center justify-center bg-gray-50 p-6 dark:bg-gray-900">
        <div class="w-full max-w-md">
            <div class="mb-6 text-center">
                <h1 class="text-title-sm font-semibold text-gray-800 dark:text-white/90">Admin Olimpiade</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Masuk untuk mengelola ujian &amp; peserta.</p>
            </div>
            ...
            <p class="mt-5 text-center text-sm text-gray-500 dark:text-gray-400">
                Peserta ujian? <a href="{{ route('login') }}" class="text-brand-500 hover:text-brand-600">Masuk di sini</a>
            </p>
        </div>
    </div>
</x-layouts.guest>
